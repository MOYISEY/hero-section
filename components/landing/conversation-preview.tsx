...
export function ConversationPreview() {
  ...
  return (
    <div className="border border-border bg-surface px-6 py-7 md:px-9 md:py-9">
      <header className="flex items-baseline justify-between gap-4 pb-4 border-b border-border">
        <div>
          <p className="nb-eyebrow">Стенограмма</p>
  ...
  return (
    <li className="grid grid-cols-[64px_1fr] items-baseline gap-4 nb-fade-up">
      ...
      <p
        className={
          isAi
            ? "font-display text-[17px] leading-[1.45] italic text-foreground"
